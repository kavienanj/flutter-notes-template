...
import 'package:flutter_notes_template/views/widgets/notes/note_details_thread.dart';
              ...
              return StatefulBuilder(
                builder: (context, setState) {
                  return Column(
                    ...
                    children: [
                      if (note != null) NoteDetailsToggleThread(note: note),
                      Padding(
